...
## 1. 占位符已替换为 victor8613 ✅

`package.json` / 卡片 footer(`src/render-svg.ts`)/ 引流帖里的占位符已全部替换为
`victor8613/cc-checkup`,卡片也已重新生成。若以后换账号名,改完跑:
...
git branch -M main
git remote add origin https://github.com/victor8613/cc-checkup.git
